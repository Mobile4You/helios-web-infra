...
class InstancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instance" do
    assert_difference('Instance.count') do
      post instances_url, params: { instance: { hostname: @instance.hostname, profile_id_id: @instance.profile_id_id, region: @instance.region } }
    end
  ...
  test "should update instance" do
    patch instance_url(@instance), params: { instance: { hostname: @instance.hostname, profile_id_id: @instance.profile_id_id, region: @instance.region } }
